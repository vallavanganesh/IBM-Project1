...
Original file is located at
    https://colab.research.google.com/drive/1vymyDz7Ro0QkjD1qA-qgFAjDaVRnV7D8
"""

!pip install transformers torch gradio -q# run this project file in google collab by changing run type to T4 GPU
